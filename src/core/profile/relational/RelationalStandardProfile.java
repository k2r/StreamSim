 ...
 */
public class RelationalStandardProfile implements IRelationalStreamProfile {
	...
	public RelationalStandardProfile(double duration, int nbElementPerTick) {
	...
	/*Two profiles are equivalent if they have same type, duration and rate*/
	@Override
	public boolean equals(Object o) {
		IStreamProfile profile = (IStreamProfile) o;
		return (this.type == profile.getType() && this.duration == profile.getDuration() && this.nbElementPerTick == profile.getNbElementPerTick());
	}
}