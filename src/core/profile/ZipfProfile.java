 ...
 *
 */
public class ZipfProfile implements IStreamProfile {
	...
	public ZipfProfile(double duration, int nbElementPerTick) {
	...
	public ZipfProfile(double duration, int nbElementPerTick, double skew) {
